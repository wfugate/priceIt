...
//        [HttpDelete("{cartId}")]
//        public async Task<IActionResult> DeleteCart(string cartId, [FromBody] DeleteCartRequest request)
//        {
//            if (string.IsNullOrEmpty(request.UserId))
//            {
//                return BadRequest("User ID is required");
...
//            try
//            {
//                bool result = await _cartService.DeleteCart(request.UserId, cartId);
//                if (result)
//                {
...
//                else
//                {
//                    return NotFound(new { success = false, message = "Cart not found or user doesn't have access" });
//                }
//            }
//            catch (Exception ex)
//            {
